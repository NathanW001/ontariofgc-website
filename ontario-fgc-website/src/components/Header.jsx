    ...
    <>
      <div className='top-bar'>
        ...
        <div className='nav-buttons'>
          <button className='nav-button' onClick={() => {document.getElementById('about').scrollIntoView();}}>About Us</button>
          <p className='nav=spacer'>|</p>
          <button className='nav-button' onClick={() => {document.getElementById('organizations').scrollIntoView();}}>Local Organizations</button>
          <p className='nav=spacer'>|</p>
